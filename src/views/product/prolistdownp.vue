<template>
	<section>
      ...
      <el-table-column prop="sellNum" label="月售数量" min-width="100"></el-table-column>
      ...
      <!-- <el-table-column prop="groupBuyingRate" label="订单奖励" width="120">
			...
			<el-table-column label="操作" width="200">
				<template scope="scope">
					...
					<el-button type="danger" size="small" @click="gocheckpass(scope.row.productId)">下架</el-button>
				</template>
			</el-table-column>
		</el-table>
...
<script>
	...
	import { getprolistdown, dprocheckpass, getproducttype } from '../../api/api';
