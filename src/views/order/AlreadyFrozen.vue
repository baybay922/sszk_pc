<template>
  <div class="content">
    ...
    <h5>全部冻结的订单（{{ totalNum }}单）</h5>
      ...
      <!-- 订单冻结 -->
      <el-dialog title="订单解冻" :visible.sync="passwindow" :close-on-click-modal="false">
...
import { orderQuery ,frzOrder,cancelOrder, FrozenList} from '../../api/api'
export default {
    data(){
        return{
            filters:{
