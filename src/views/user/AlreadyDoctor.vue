	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.orgName" placeholder="请输入查询信息" ></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" style="width: 100%;">
			<el-table-column prop="orgName" label="姓名">
			</el-table-column>
			...
			<el-table-column prop="leaderPhone" label="手机号">
			</el-table-column>
...
import { doctorInfo,lockAccount, quickcreate, getAllpdoduct} from '../../api/api';
...
export default {
	...
	methods: {
		...
		separate(orgId){
          let path = {path:'/separate',query:{orgId:orgId,orgType:'D'}}
