        ...
        <template scope="scope">
          ...
          <div class="contentMark" v-if="markShow">
						<div class="content">
							...
							<el-button size="small" @click="closeMark()" class="closeBtn">关闭</el-button>
						</div>
          </div>
        </template>
      </el-table-column> -->
			<el-table-column label="营业执照">
				<template scope="scope">
					<a :href="scope.row.companyImg" target='blank' style="text-decoration:none">查看图片</a>
				</template>
			</el-table-column>
...
<script>
	...
	import { get2pUserList,supplierCheck,supplierauditre} from '../../api/api';
